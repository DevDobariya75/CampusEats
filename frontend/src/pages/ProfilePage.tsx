      ...
      <div className="card p-6">
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <div className="mt-1 text-base font-extrabold text-slate-900">{user?.name}</div>
          </div>
          <div>
            <div className="text-xs font-bold text-slate-500">EMAIL</div>
            <div className="mt-1 text-base font-extrabold text-slate-900">{user?.email}</div>
          </div>
          <div>
            <div className="text-xs font-bold text-slate-500">ROLE</div>
            <div className="mt-1 text-base font-extrabold text-slate-900">{user?.role}</div>
          </div>
        </div>
