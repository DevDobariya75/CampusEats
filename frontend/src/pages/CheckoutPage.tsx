...
export function CheckoutPage() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'cash' | 'card' | 'campus_card' | 'online' | 'upi'>('cash');
    ...
    <div className="space-y-6">
      <div className="card p-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          ...
          <b className="text-slate-900">{user?.name ?? 'User'}</b>.
        </p>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <div className="card p-5">
            <div className="text-base font-extrabold text-slate-900">Delivery Location</div>
          ...
          <div className="card p-5">
            <div className="text-base font-extrabold text-slate-900">Payment</div>
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              {(['cash', 'card', 'campus_card', 'online', 'upi'] as const).map((m) => (
                <button
                  key={m}
                  type="button"
          ...
          <div className="card p-5">
            <div className="text-base font-extrabold text-slate-900">Notes</div>
            <textarea
        ...
        <div className="card p-5">
          <div className="text-lg font-black text-slate-900">Order summary</div>
          <div className="mt-1 text-sm text-slate-600">{shop.name}</div>
